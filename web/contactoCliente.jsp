                                ...
                                <div class="col-sm-8">
                                    <div class="nav navbar-nav navbar-right pull-right">
                                        <ul class="nav navbar-nav">
                                            <li><a href="AdminPanel/perfilCliente.jsp"><i class="fa fa-user"></i> Perfil</a></li>
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="mainmenu pull-left">
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    ...
                                    <li><a href="ventanaCliente.jsp" class="active">Blog</a></li>
                    ...
                    <div class="col-sm-8">
                        <div class="contact-form">
                            ...
                            <form action="resultadoDoctor.jsp" id="main-contact-form" class="contact-form row" method="post">
                                ...
                                <div class="form-group col-md-12">
                                    <textarea id="mensaje"name="mensaje" cols="40" rows="10" placeholder="Peticion...Ingrese su correo" required="required" name="message" id="message" required="required" class="form-control"></textarea>
                                </div>                     
                                <div class="form-group col-md-12">
