                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="tiporol" class="form-control"  required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" onkeyup="this.form.passworde.value = md5(this.form.password.value)"
                    ...
                    <div class="container-fluid">
                        <nav class="float-left">
                            <ul>
                                ...
                                <li>
                                    <a href="AdminPanel/listadoBlog.jsp">
                                        Blog
                                    </a>
                                </li>
                                <li>
