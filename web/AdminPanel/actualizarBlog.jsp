                ...
                <div class="sidebar-wrapper">
                    <ul class="nav">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="actualizarBlog.jsp">
                                <i class="material-icons">person</i>
                                <p>Actualizar Blog</p>
                            </a>
                        </li>
                                    ...
                                    <div class="card-body">
                                        <%
                                            if (request.getParameter("id") != null) {
                                                ...
                                                Blog b = bi.seleccionarBlog(id);
                                                if (b != null) {
                                        %>
                                        <form action="../ActualizarBlogController" method="Post">
                                            <input type="hidden" value="<%= b.getIdblog()%>" name="id">
                                            <img src="../<%= b.getImagenB()%> "width="100" height="100" />
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <div class="file-field input-field">
                                                        ...
                                                        <div class="file-path-wrapper">
                                                            <input class="file-path validate" type="text" name="imagenB" value="<%= b.getImagenB()%>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        ...
                                                        <div><input type="text" name="codigo" class="form-control" value="<%= b.getCodigo()%>"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        <label name="">Fecha Blog</label>
                                                        <input type="text" name="fechaB" class="form-control" value="<%= b.getFechaB()%>">
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Comentario</label>
                                                        <input type="text" name="texto" class="form-control" value="<%= b.getTexto()%>">
                                                    </div>
                                                </div>
                                            </div>
