                ...
                <div class="sidebar-wrapper">
                    <ul class="nav">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="perfilAdministrador.jsp">
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        %>
                                        <form action="../ActualizarAdministradorController" method="Post">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Rol de Usuario</label>
                                                        <input type="text"  value="<%= u.getTiporol()%>" name="tiporol" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Cedula</label>
                                                        <input type="text" value="<%= u.getCedula()%>" name="cedula" class="form-control"  required> 
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Usuario</label>
                                                        <input type="text" value="<%= u.getUser()%>" name="user" class="form-control"  required> 
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Contraseña</label>
                                                        <input type="password" value="<%= u.getPassword()%>" onkeyup="this.form.passworde.value = md5(this.form.password.value)"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<%= u.getEmail()%>" name="email" class="form-control"  required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<%= u.getNombre()%>" name="nombre" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Apellido(s)</label>
                                                        <input type="text" value="<%= u.getApellido()%>" name="apellido" class="form-control"  required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<%= u.getTelefono()%>" name="telefono" class="form-control"  required>
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="submit" class="btn btn-info pull-right btn-round" value="REGISTRAR">
