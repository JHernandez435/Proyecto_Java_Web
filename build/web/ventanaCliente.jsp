                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="mainmenu pull-left">
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    ...
                                    <li><a href="AdminPanel/blogCliente.jsp" class="active">Blog</a></li>
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            <%
                                ...
                                ArrayList<Medicamento> listadoMedicamentoCliente = new ArrayList<>();
                                listadoMedicamentoCliente = mi.listarMedicamentoCliente();
                                for (Medicamento md : listadoMedicamentoCliente) {
                            %>
                            <div class="col-sm-4">
