<%-- 
    ...
    Created on : 10/08/2020, 11:28:11 AM
    Author     : JFERNANDOHA
--%>
...
<html>
    ...
    <body>
        <div class="wrapper ">
            <div class="sidebar" data-color="orange" data-background-color="black" data-image="../images/sidebar-1.jpg">
                <!--
                ...
                <div class="sidebar-wrapper">
                    <ul class="nav">
                        ...
                        <li class="nav-item active ">
                            <a class="nav-link" href="actualizarMedicamento.jsp">
                                <i class="material-icons">person</i>
                                <p>Actualizar Medicamento</p>
                            </a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header card-header-warning ">
                                        <h4 class="card-title">Editar Medicamento Seleccionado</h4>
                                        <p class="card-category">PHARMA COMPANY</p>
                                    </div>
                                    <div class="card-body">
                                        <%
                                            if (request.getParameter("id") != null) {
                                                ...
                                                Medicamento m = mi.seleccionarMedicamento(id);
                                                if (m != null) {
                                        %>

                                        <form action="../ActualizarMedicamentoController" method="Post">
                                            <input type="hidden" value="<%= m.getIdmedicamento()%>" name="id">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="file-field input-field">
                                                        <center><img src="../<%= m.getImagenP()%> "width="100" height="100" /></center>
                                                        <div class="btn">
                                                            <span>Insertar Imagen Del Producto</span>
                                                            <br><input type="file"></br>
                                                        </div>
                                                        <div class="file-path-wrapper">
                                                            <input class="file-path validate" name="rutaP" type="text" value="<%= m.getImagenP()%>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="file-field input-field">
                                                        <center><img src="../<%= m.getImagenD()%> "width="100" height="100" /></center>
                                                        <div class="btn">
                                                            <span>Insertar Detalle Del Producto</span>
                                                            <br><input type="file"></br>
                                                        </div>
                                                        <div class="file-path-wrapper">
                                                            <input class="file-path validate" name="rutaD" type="text" value="<%= m.getImagenD()%>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" required  value="<%= m.getCodigo()%>" name="codigo">
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Nombre del Producto</label>
                                                        <input type="text" class="form-control" required  value="<%= m.getNombre()%>" name="nombre">
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Fecha Expedición</label>
                                                        <input type="text" class="form-control" required  value="<%= m.getFechaE()%>" name="fechaE" redonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Fecha Vencimiento</label>
                                                        <input type="text" class="form-control" required  value="<%= m.getFechaV()%>" name="fechaV">
                                                    </div>
                                                </div>
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Codigo Paypal</label>
                                                        <input type="text" id="paypal" class="form-control" value="<%= m.getPaypal()%>" name="paypal">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="precio" class="form-control" value="<%= m.getPrecio()%>" name="precio">
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Categoria para Usuario</label>
                                                        <input type="text" id="categoria" class="form-control" value="<%= m.getCategoria()%>" name="categoria">
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="submit" class="btn btn-warning pull-right" value="REGISTRAR">
                        ...
                        <div class="col-md-4">
                            <div class="card card-profile">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="https://www.sandbox.paypal.com/mep/dashboard" TARGET="_BLANK" class="btn btn-warning btn-round">Crear Boton Paypal</a>
