<%-- 
    ...
    Created on : 10/08/2020, 08:52:15 AM
    Author     : JFERNANDOHA
--%>
                        ...
                        <div class="collapse navbar-collapse justify-content-end">
                            <form class="navbar-form">
                                <div class="input-group no-border">
                                    <input type="text" value="" class="form-control" name="buscar" placeholder="CODIGO...">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-warning">
                                        <h4 class="card-title ">Medicamento Encontrado</h4>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table">
                                                ...
                                                <%
                                                    ...
                                                    ArrayList<Medicamento> listadoMedicamento = new ArrayList<>();
                                                    listadoMedicamento = mi.buscarMedicamentoPorCodigo(valor);
                                                    for (Medicamento m : listadoMedicamento) {
                                                %>
                                                <tr>
                                                    <td><img src="../<%= m.getImagenP()%> "width="75" height="75"/></td>
                                                    <td><img src="../<%= m.getImagenD()%> "width="75" height="75"/></td>
                                                    <td><%= m.getCodigo()%></td>
                                                    <td><%= m.getNombre()%></td>
                                                    <td><%= m.getFechaE()%></td>
                                                    <td><%= m.getFechaV()%></td>
                                                    ...
                                                    <td>
                                                        <form action="actualizarMedicamento.jsp" method="Post">
                                                            ...
                                                            <input type="submit" class="btn btn-warning btn-round btn-just-icon" value="A"></input>
                                                        </form>
                                                    </td>
                                                    <td>
                                                        <form action="../EliminarMedicamentoController" method="Post">
                                                            <div class="modal fade" id="<%= m.getCodigo()%>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="table-responsive">
                                                                                    <table class="table table-hover">
                                                                                        <thead>
                                                                                        <th><center><h4>¿Desea Eliminar El Medicamento <%= m.getNombre()%>?</h4></center><th>
                                                                                            </thead>                                                                                                                     
                                                                                        <tr>
                                                                                            <td>
                                                                                        <center>
                                                                                            <img src="../<%= m.getImagenP()%> "width="300" height="300"/>
                                                                                            <br>
                                                                                            <br>
                                                                                            <div class="modal fade" id="<%= m.getNombre()%>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                                                <div class="modal-dialog" role="document">
                                                                                                    <div class="modal-content">
                                                            ...
                                                            <button type="button" class="btn btn-danger btn-round btn-just-icon" data-toggle="modal" data-target="#<%= m.getCodigo()%>">
                                                                E
                                                            </button>
                                                    </td>
                                                </tr>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-warning">
                                        <h4 class="card-title mt-0">Listado De Medicamentos Registrados</h4>
                                        <p class="card-category">Datos de los Medicamentos</p>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <%
                                                    MedicamentoImplement mi = new MedicamentoImplement();
                                                    ArrayList<Medicamento> listadoMedicamento = new ArrayList<>();
                                                    listadoMedicamento = mi.listarMedicamento();
                                                    for (Medicamento m : listadoMedicamento) {
                                                %>
                                                <tr>
                                                    <td><img src="../<%= m.getImagenP()%> "width="75" height="75" /></td>
