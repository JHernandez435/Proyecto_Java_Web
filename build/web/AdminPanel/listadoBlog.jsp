...
<html>
    ...
    <body>
        <div class="wrapper ">
            <div class="sidebar" data-color="azure" data-background-color="black" data-image="../images/sidebar-1.jpg">
                <!--
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header card-header-info">
                                        ...
                                        <p class="card-category">Completa los campos asignados</p>
                                    </div>
                                    <div class="card-body">
                                        <form name="a" action="../BlogController" method="Post">
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <div class="file-field input-field">
                                                        <div class="btn">
                                                            <span>Inserte La Imagen</span>
                                                            <br><input type="file" name="imagenB"></br>
                                                        </div>
                                                ...
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        ...
                                                        <div><input type="text" name="codigo" class="form-control"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        <label name="">Fecha Blog</label>
                                                        <input type="date" name="fechaB" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                            ...
                                            <ul class="nav nav-pills nav-justified">
                                                ...
                                                <button type="button" class="btn btn-info btn-round" data-toggle="modal" data-target="#1">
                                                    Guardar
                                                </button>                                         
                                            </ul>
                                        </form>
                            ...
                            <div class="col-md-4">
                                <div class="card card-profile">
                                    ...
                                    <div class="card-body">
                                        <h6 class="card-category text-gray">¡¡¡ BIENVENIDO !!!</h6>
                                        <h4 class="card-title"><%=ss.getAttribute("user")%></h4>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table">
                                                ...
                                                <%
                                                    ...
                                                    listadoBlog = bi.buscarBlogPorCodigo(valor);
                                                    for (Blog b : listadoBlog) {
                                                %>
                                                <tr>
                                                    <td><img src="../<%= b.getImagenB()%>"width="75" height="75"/></td>
                                                    <td><%= b.getCodigo()%></td>
                                                    <td><%= b.getFechaB()%></td>
                                                    <td><%= b.getTexto()%></td>
                                                    <td>
                                                        <form id="f1" action="actualizarBlog.jsp" method="Post">
                                                            <input type="hidden" value="<%= b.getIdblog()%>" name="id"></input>
                                                            <input type="submit" class="btn btn-success btn-round btn-just-icon" value="A"></input>
                                                        </form>
                                                    </td>
                                                    <td>
                                                        <form action="../EliminarBlogController" method="Post">
                                                            <div class="modal fade" id="<%= b.getCodigo()%>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                                ...
                                                                                <div class="table-responsive">
                                                                                    <table class="table table-hover">
                                                                                        ...
                                                                                        <center>
                                                                                            ...
                                                                                            <form action="../EliminarBlogController" method="Post">
                                                                                                <input type="hidden" value="<%=b.getIdblog()%>" name="id">
                                                            ...
                                                            <button type="button" class="btn btn-danger btn-round btn-just-icon" data-toggle="modal" data-target="#<%= b.getCodigo()%>">
                                                                E
                                                            </button>
                                                        </form>
                                                    </td>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%= b.getTexto()%></td>
                                                    <td>
                                                        <form action="actualizarBlog.jsp" method="Post">
                                                            <input type="hidden" value="<%= b.getIdblog()%>" name="id"></input>
                                                            <input type="submit" class="btn btn-success btn-round btn-just-icon" value="A"></input>
                                                        </form>
                                                    </td>
