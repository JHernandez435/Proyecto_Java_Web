...
<%
    ...
    if (ss.getAttribute("user") != null) {
        if (ss.getAttribute("tiporol").equals("Cliente")) {
%>
<html lang="en">
    <head>
        <meta charset="utf-8">
                                ...
                                <div class="col-sm-8">
                                    <div class="nav navbar-nav navbar-right pull-right">
                                        <ul class="nav navbar-nav">
                                            <li><a href="perfilCliente.jsp"><i class="fa fa-user"></i> Perfil</a></li>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                <li><a href="../ventanaCliente.jsp" class="active">Inicio</a></li>
                                <li><a href="https://drive.google.com/file/d/1RZ24UHRQf-BRTJEr1KfhjWDihR8S9DJi/view?usp=sharing">Portafolio</a></li>
                                <li><a href="blogCliente.jsp" class="active">Blog</a></li>
                                <li><a href="../contactoCliente.jsp">Contacto</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">  	
                <div class="col-sm-8">
                    <div class="contact-form">
                        ...
                        %>
                        <form action="../ActualizarClienteController" id="main-contact-form" class="contact-form row" method="post">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Company (Rol)</label>
                                    <input type="text" id="nombre" class="form-control" value="<%= u.getTiporol()%>" name="nombre" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Cedula</label>
                                    <input type="text" id="nombre" class="form-control" value="<%= u.getCedula()%>" name="nombre" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Usuario</label>
                                    <input type="text" id="nombre" class="form-control" value="<%= u.getUser()%>" name="nombre" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Contraseña</label>
                                    <input type="password" id="nombre" class="form-control" value="<%= u.getPassword()%>" name="nombre" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Correo Electronico</label>
                                    <input type="text" id="nombre" class="form-control" value="<%= u.getEmail()%>" name="nombre" required>
                                </div>
                            </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="nombre" class="form-control" value="<%= u.getApellido()%>" name="nombre" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="nombre" class="form-control" value="<%= u.getTelefono()%>" name="nombre" required>
                            </div>
                        </div>
                    </div>
